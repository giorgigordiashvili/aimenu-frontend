    ...
    <Link href={`/${locale}/restaurant/${slug}`} className={styles.card}>
        ...
        {averageRating && (
          <div className={styles.ratingBadge}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 1L7.545 4.13L11 4.635L8.5 7.07L9.09 10.51L6 8.885L2.91 10.51L3.5 7.07L1 4.635L4.455 4.13L6 1Z" fill="#FFB800" stroke="#FFB800" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.location}>
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 5C10 8.5 6 11 6 11C6 11 2 8.5 2 5C2 3.93913 2.42143 2.92172 3.17157 2.17157C3.92172 1.42143 4.93913 1 6 1C7.06087 1 8.07828 1.42143 8.82843 2.17157C9.57857 2.92172 10 3.93913 10 5Z" stroke="#62748E" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M6 6.5C6.82843 6.5 7.5 5.82843 7.5 5C7.5 4.17157 6.82843 3.5 6 3.5C5.17157 3.5 4.5 4.17157 4.5 5C4.5 5.82843 5.17157 6.5 6 6.5Z" stroke="#62748E" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
